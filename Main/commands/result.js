    ...
    try {
      ...
      if (data && data.length > 0) {
          ...
          if (teamName.trim() !== "") {
            ...
            try {
              ...
              try {
                ...
                console.log("LOGOSUZLAR",logosuzlar)
              }
              ...
              if (teamData.winCount >= 1) {
                ...
                context.drawImage(winnerLogo , teamNameX + 300, initialY - 36, 50, 50); // thubmail
              }
            } catch (error) {
              console.log(error)
              continue; 
        ...
        collector.on('collect', async (reaction, user) => {
            try {
                const channel = message.guild.channels.cache.get(resultkanalId);
                if (channel) {
        ...
        collector.on('end', () => {
            console.log('Reaksiyon toplama işlemi sona erdi.');
        });
